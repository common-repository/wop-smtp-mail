...
class Core {
	...
	public function hooks() {
		...
		// Activation hook.
		add_action( 'activate_wop-wordpress-smtp-mail/wop_wordpress_smtp_mail.php', array( $this, 'activate' ) );
		...
		add_action( 'admin_notices', array( '\WOPMailSMTP\WP', 'display_admin_notices' ) );
	...
	public function init() {
		...
		load_plugin_textdomain( 'wop_wordpress_smtp_mail', false, wop_wordpress_mail_smtp()->plugin_path . '/languages' );
